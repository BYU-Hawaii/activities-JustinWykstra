document.getElementById('registrationForm').addEventListener('submit', function(event) {
    ...
    var phonenumberValid = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$/.test(password); // Phonenumber should be at least 10 characters long, consider country codes, area codes, and standard number formats
    ...
    document.getElementById('phonenumberFeedback').textContent = phonenumberValid ? '' : 'Phonenumber should be at least 10 characters long, consider country codes, area codes, and standard number formats. ';
